...
2026-04-07 - Background from docs folder. On 2026-03-25 Jason emailed Trace Blethen and Adam Knoll (CC: Ashleigh Sundet, Dawn Harnasch) pitching this as a NON-POR infill SSD opportunity.
- Cincinnati SSD topology: SOH2 (West Chester) and SOH7 (further north). Next site should be infill; N. KY ruled out due to bridge traffic issues.
- Site at 320 S Wayne Ave, Lockland — inside I-275 ring, proximate I-75 access, dense in-town suburbs.
- I-75 improvements planned short/medium term, including new interchange at southern boundary of this property.
- Requires assemblage; developer reportedly getting it under control.
- Historical use: shingle manufacturing. Purchased and remediated by Cincinnati Port Authority — potential enviro flag.
- Jason asked Trace/Adam to run Flash enviro to see if it passes muster.
- Clous RD Partners prepared two conceptual site plans (V1: ~282,240 SF; V2: ~271,600 SF), both March 2026.

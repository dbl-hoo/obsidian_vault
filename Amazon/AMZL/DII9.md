...
- Adverse Effect notice to consulting parties → May 14, 2026 (done)
- Consulting party comments → +30 days (~Jun 13)
- USACE provides comments to Scannell → +7 days (~Jun 20)
- WV SHPO meeting (Scannell + client + CEC) → +3 days (~Jun 23); ~week of June 2 per prior scheduling
- First round MOA: CEC drafts (+4d) → Scannell/client review (+21d) → CEC edits (+7d) → USACE comments (+30d) → CEC incorporates (+7d) → Scannell/client review (+14d) → CEC final draft (+7d) → consulting party comment period (+30d) → USACE consolidates comments (+37d)
- Second round MOA: repeat of above (estimated ~3–4 more months)
- Signature: final to Scannell (+7d) → Scannell to USACE (+14d) → signatures (+30d)
- **Rough total: 6–9 months from May 14 → signatures likely Q1 2027 at earliest**

**Required MOA stipulations:**
- Landscape plan (May 1, 2026 version; 5-yr monitoring, 100% success rate, annual reporting)
- Project design/orientation relative to avoidance/minimization of Alexander-Caldwell Farm
- Inadvertent discovery plan (standard, per USACE recommendation)

**Potential MOA stipulations:**
- Historic context for Alexander-Caldwell Farm (CEC recommends against committing to full NRHP nomination — too costly/time-consuming)
- Interpretive wayside panel (location TBD between Scannell, USACE, WV SHPO, Caldwell Family)

**CEC contacts:** Molly Soffietti (PM III) and Eric Scuoteguazza (Principal, Cultural Resources, Pittsburgh)

2026-05-27 - BRS specs (updated 11/15/2022). Centroid: 25304.
BTS BRS: 102k sf, 13.2 ac, delivery Oct 2027, 13 dock doors, 2000A/4000A power, 219 AA / 478 van / 18–42 box truck / 0 trailer.
DS Lite BRS: 20k sf, 2 dock doors, 1000A/2000A, 30 AA / 64 van / 0 box truck / 1 trailer.
Existing/Spec BRS: 118k–136k sf, 10 dock doors, 1600A/3200A, 180 AA / 339 van / 12–32 box truck / 3 trailer.

2026-05-27 - [Source: email] Matter opened. Taking over from Andrea Roy (Amazon contractor, departing). BTS in Putnam County WV (Frazier's Bottom). Section 106 NHPA consultation active with USACE/SHPO; PCN-39 Army Corps permit in process (case LRH-2023-788-KAN, USACE file 24-0238-PU-4). PSA in place — expires end of May 2026; two 30-day extensions available at $10k NR/NA each, seller amenable per Holdeman. SHPO meeting scheduled ~week of June 2 with CEC, SHPO, and USACE. CEC cost estimate due EOW. Jason Miller (3rd party) requesting meeting re Corps permit — Holdeman recommends cordial deferral until after SHPO mtg; will draft formal response with legal/CEC input.
Attachments: 352-622-Frazier's Bottom Section 106 Steps Forward Memo-05.22.26.docx, Meeting request for Project Kanawha Corps PCN-39 Permit.eml

**Key contacts:**
Frank Taylor, Sr. Development Manager, Amazon Global Realty — frankjt@amazon.com — 954-795-4387
Jacob Holdeman, Director of Development, Scannell Properties — jacob@scannellproperties.com — 574-370-9392
Andrea Roy (departing Amazon contractor) — aandroy@amazon.com
Kate Bagwell, Amazon — kmbag@amazon.com
Danielle Aristy, Amazon — aristyd@amazon.com
Andrew Alberg, Amazon — aalberg@amazon.com
Keith J. Seo, Summit Law (local counsel) — keiths@summitlaw.com
David Duncan, Scannell Properties — davidd@scannellproperties.com
